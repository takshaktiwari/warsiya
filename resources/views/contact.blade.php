<x-app-layout>
    <x-breadcrumb title="Contact Us" :links="[['text' => 'Home', 'url' => url('/')], ['text' => 'Contact Us']]" />
                    ...
                    <div class="contact__wrapper">
                        <div class="section__title-wrapper mb-40">
                            <h2 class="section__title">
                                Get in<span class="yellow-bg yellow-bg-big">touch</span>
                            </h2>
                            <p>
                                        ...
                                        <div class="contact__info-text">
                                            ...
                                            <p>
                                                <a target="_blank"
                                                    ...
                                                    Crescent 70-80 Upper St Norwich NR2
                                                    1LT</a>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="contact__info-text">
                                            ...
                                            <p>
                                                <a
                                                    ...
                                                    <span class="__cf_email__">abc@gmail.com</span>
                                                </a>
                                            </p>
                                            <p>
                                                <a
