<x-app-layout>
    ...
    <div class="tp-hero__section pt-130 theme-bg p-relative fix">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="tp-hero__img">
                        <img src="{{ asset('assets/img/hero/hero-img-1.png') }}" alt="hero">
                    </div>
                </div>
            </div>
        </div>
        <div class="tp-hero__shapes">
            <div class="tp-hero__shapes-1">
                <img src="{{ asset('assets/img/icons/book-shape.png') }}" alt="">
            </div>
            <div class="tp-hero__shapes-2">
                <img src="{{ asset('assets/img/icons/circle-shape.png') }}" alt="">
            </div>
            <div class="tp-hero__shapes-3">
                <img src="{{ asset('assets/img/icons/dots-shapes.png') }}" alt="">
            </div>
            <div class="tp-hero__shapes-4">
                <img src="{{ asset('assets/img/icons/line-shape.png') }}" alt="">
            </div>
            <div class="tp-hero__shapes-5">
                <img src="{{ asset('assets/img/icons/lines-shape.png') }}" alt="">
            </div>
            <div class="tp-hero__shapes-6">
                <img src="{{ asset('assets/img/icons/role-shape.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- hero section end  -->
            ...
            <div class="row gx-70">
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-1 mb-30">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/design-icon.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-2 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/man-cions.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-3 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/code-cions.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-4 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/bag-icon.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-5 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/music-icons.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-6 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/doller-icon.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-7 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/cal-icon.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="tp-feature__item before-color-8 mb-40">
                        <div class="tp-feature__icon">
                            <img src="{{ asset('assets/img/icons/pen-icon.png') }}" alt="">
                        </div>
                    ...
                    <div class="tab-pane fade show active" id="pills-all" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="tp-courses__item mb-30">
                                    <div class="tp-courses__thumb w-img fix p-relative">
                                        <img src="{{ asset('assets/img/courses/courses-2.jpg') }}" alt="">
                                    ...
                                    <div class="tp-courses__content">
                                        ...
                                        <div class="tp-courses__avata">
                                            <img src="{{ asset('assets/img/courses/avata/course-avata-2.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="tp-courses__item mb-30">
                                    <div class="tp-courses__thumb w-img fix p-relative">
                                        <img src="{{ asset('assets/img/courses/courses-1.jpg') }}" alt="">
                                    ...
                                    <div class="tp-courses__content">
                                        ...
                                        <div class="tp-courses__avata">
                                            <img src="{{ asset('assets/img/courses/avata/course-avata-1.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="tp-courses__item mb-30">
                                    <div class="tp-courses__thumb w-img fix p-relative">
                                        <img src="{{ asset('assets/img/courses/courses-4.jpg') }}" alt="">
                                    ...
                                    <div class="tp-courses__content">
                                        ...
                                        <h3 class="tp-courses__title"><a href="course-details.html">AWS Certified
                                                ...
                                                Associate.</a></h3>
                                        <div class="tp-courses__avata">
                                            <img src="{{ asset('assets/img/courses/avata/course-avata-4.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="tp-courses__item mb-30">
                                    <div class="tp-courses__thumb w-img fix p-relative">
                                        <img src="{{ asset('assets/img/courses/courses-3.jpg') }}" alt="">
                                    ...
                                    <div class="tp-courses__content">
                                        ...
                                        <div class="tp-courses__avata">
                                            <img src="{{ asset('assets/img/courses/avata/course-avata-3.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="tp-courses__item mb-30">
                                    <div class="tp-courses__thumb w-img fix p-relative">
                                        <img src="{{ asset('assets/img/courses/courses-5.jpg') }}" alt="">
                                    ...
                                    <div class="tp-courses__content">
                                        ...
                                        <div class="tp-courses__avata">
                                            <img src="{{ asset('assets/img/courses/avata/course-avata-5.jpg') }}"
                                                alt="">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="tp-courses__item mb-30">
                                    <div class="tp-courses__thumb w-img fix p-relative">
                                        <img src="{{ asset('assets/img/courses/courses-6.jpg') }}" alt="">
                                    ...
                                    <div class="tp-courses__content">
                                        ...
                                        <div class="tp-courses__avata">
                                            <img src="{{ asset('assets/img/courses/avata/course-avata-6.jpg') }}"
                                                alt="">
    ...
    {{-- <div class="tp-event__section pt-120 pb-90 p-relative">
        <div class="tp-event__shape">
            ...
            <div class="event-2">
                <img src="{{ asset('assets/img/icons/event-circle.png') }}" alt="">
            </div>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="tp-event__wrapper">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-event__item mb-30">
                            <div class="tp-event__thumb w-img fix">
                                <img src="{{ asset('assets/img/event/event-thumb-1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-event__item mb-30">
                            <div class="tp-event__thumb w-img fix">
                                <img src="{{ asset('assets/img/event/event-thumb-2.jpg') }}" alt="">
                            </div>
                            <div class="tp-event__content">
                                <div class="tp-event__meta mb-10">
                                    <span class="event-date"><i class="fa-solid fa-circle-small"></i> February 13,
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-event__item mb-30">
                            <div class="tp-event__thumb w-img fix">
                                <img src="{{ asset('assets/img/event/event-thumb-3.jpg') }}" alt="">
                            </div>
                            <div class="tp-event__content">
                                <div class="tp-event__meta mb-10">
                                    <span class="event-date"><i class="fa-solid fa-circle-small"></i> February 13,
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-event__item mb-30">
                            <div class="tp-event__thumb w-img fix">
                                <img src="{{ asset('assets/img/event/event-thumb-4.jpg') }}" alt="">
                            </div>
                            <div class="tp-event__content">
                                <div class="tp-event__meta mb-10">
                        ...
                        <div class="col-lg-10">
                            <div class="tp-testimonial__slider">
                                <div class="tp-testimonial__box d-md-flex white-bg align-items-center">
                                    <img src="{{ asset('assets/img/testimonial/testimonial-thumb.jpg') }}"
                                        alt="">
                                ...
                                <div class="tp-testimonial__box d-md-flex white-bg align-items-center">
                                    <img src="{{ asset('assets/img/testimonial/testimonial-thumb-2.jpg') }}"
                                        alt="">
                                    <div class="tp-testimonial__review">
                                        <span class="tp-testimonial__quote"><i
                                                class="fa-solid fa-quote-left"></i></span>
                                ...
                                <div class="tp-testimonial__box d-md-flex white-bg align-items-center">
                                    <img src="{{ asset('assets/img/testimonial/testimonial-thumb-3.jpg') }}"
                                        alt="">
                                    <div class="tp-testimonial__review">
                                        <span class="tp-testimonial__quote"><i
                                                class="fa-solid fa-quote-left"></i></span>
                                ...
                                <div class="tp-testimonial__box d-md-flex white-bg align-items-center">
                                    <img src="{{ asset('assets/img/testimonial/testimonial-thumb-4.jpg') }}"
                                        alt="">
                                    <div class="tp-testimonial__review">
                                        <span class="tp-testimonial__quote"><i
                                                class="fa-solid fa-quote-left"></i></span>
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="tp-team__member fix mb-30">
                            <div class="tp-team__img w-img tp-team__overlay p-relative">
                                <a href="instructor-details.html">
                                    <img src="{{ asset('assets/img/team/team-1.1.jpg') }}" alt="">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-team__member fix mb-30">
                            <div class="tp-team__img w-img tp-team__overlay p-relative">
                                <a href="instructor-details.html">
                                    <img src="{{ asset('assets/img/team/team-1.2.jpg') }}" alt="">
                                </a>
                                <div class="tp-team__info text-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-team__member fix mb-30">
                            <div class="tp-team__img w-img tp-team__overlay p-relative">
                                <a href="instructor-details.html">
                                    <img src="{{ asset('assets/img/team/team-1.3.jpg') }}" alt="">
                                </a>
                                <div class="tp-team__info text-center">
                                    <h3 class="tp-team__name">Andra Flatcher</h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="tp-team__member fix mb-30">
                            <div class="tp-team__img w-img tp-team__overlay p-relative">
                                <a href="instructor-details.html">
                                    <img src="{{ asset('assets/img/team/team-1.4.jpg') }}" alt="">
                                </a>
                                <div class="tp-team__info text-center">
                                    <h3 class="tp-team__name">Andra Flatcher</h3>
                                    <span>Teacher MBA</span>
